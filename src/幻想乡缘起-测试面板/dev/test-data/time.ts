...
// 预期: new* 均为 false
export const timeTest_Initial = _.merge(_.cloneDeep(baseTestData), {
  世界: { timeProgress: 0 },
  cache: undefined, // cache 为空，模拟首次运行
});

// 场景 2: 时间推进，但不跨越任何边界 (2025-10-24 06:10 JST, 清晨)
// 预期: new* 均为 false
export const timeTest_NoChange = _.merge(_.cloneDeep(baseTestData), {
...
export const timeTest_NewPeriod = _.merge(_.cloneDeep(baseTestData), {
...
export const timeTest_NewDay = _.merge(_.cloneDeep(baseTestData), {
...
// 预期: newWeek=true, ...
export const timeTest_NewWeek = _.merge(_.cloneDeep(baseTestData), {
...
// 预期: newMonth=true, ...
export const timeTest_NewMonth = _.merge(_.cloneDeep(baseTestData), {
...
// 预期: newSeason=true, ...
export const timeTest_NewSeason = _.merge(_.cloneDeep(baseTestData), {
...
// 预期: newYear=true, ...
export const timeTest_NewYear = _.merge(_.cloneDeep(baseTestData), {
